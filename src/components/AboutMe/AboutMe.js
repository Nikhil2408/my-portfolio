    ...
    return (
        <div className="AboutMe">
            ...
            <div className="AboutMe-intro">
                ...
                <div className="AboutMe-details">A passionate frontend web developer from India. Currently I am working as a software enginner in Accenture. I have done my B.Tech in Computer Science and got graduated in 2020.</div>
