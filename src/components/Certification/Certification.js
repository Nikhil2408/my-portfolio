        ...
        <div id="Certification" className="Certification">
            ...
            <div className="Certification-container">
                <div className="Certification-details">
                    ...
                    <a href="https://drive.google.com/file/d/1h4YW9iAwwUaVObltatYusQG0R0PrzVh0/view?usp=sharing" target = "_blank" rel="noreferrer">View Certificate</a>
                ...
                <div className="Certification-badge">
                    <img src={certi_badge} alt="certi-badge"/>
                </div>
            </div>
        </div>
    )
